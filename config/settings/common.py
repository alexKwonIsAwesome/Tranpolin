# -*- coding: utf-8 -*-
"""
Django settings for Tranpolin project.
...
LOCAL_APPS = (
    # custom users app
    'tranpolin.users.apps.UsersConfig',
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'tranpolin.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'tranpolin.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'tranpolin.users.adapters.SocialAccountAdapter'
